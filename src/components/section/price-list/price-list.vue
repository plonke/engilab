      ...
      <SharedHalf>
        <template #left>
          <SharedSectionHeader
            title-tag="h2"
            caption="/ 04 /"
            :title="['Прайс-лист ', 'с нашими продуктами']"
        ...
        <template #right>
          ...
          >
            ...
            <SharedFieldSelect
              :class="{ 'opacity-50': isFormSent || isFormSending }"
              label="Сколько у нас есть времени на все?"
              required
              name="deadline"
      ...
      <div class="corner relative flex w-full justify-center">
        ...
        >
          ...
          >
            ...
            <!-- TODO: UPDATE LINK -->
            <div>
              Загрузка файла должна была начаться, если нет, то перейдите по
              ссылке
            </div>
          </div>
          ...
          >
            ...
            Скачать прайс-лист</SharedButton
          >
        </SharedPlate>
      </div>
    </form>
...
async function submitForm() {
  ...
  const isSent = await sendForm("Скачивание прайс-листа", {
