<template>
  <div ref="elFooter" id="footer">
    ...
    >
      <div
        class="pointer-events-none absolute left-0 flex h-full w-full flex-col items-center justify-center"
      >
        <div class="flex flex-col items-center justify-center gap-[20px]">
          <svg
            ref="elAsterisk"
            :style="{ transform: `rotate(${asteriskRotation})` }"
            class="size-[60px]"
            width="15"
            height="15"
            viewBox="0 0 15 15"
        ...
        <SharedHalf>
          <template #left>
            <div class="flex flex-col gap-[10px] lg:gap-[0px]">
              ...
              <div
                class="h-[2px] w-full bg-light-100 opacity-20 lg:hidden"
              ></div>
              <a
                v-bind="getTelegramChannelLinkAttrs()"
          ...
          <template #right>
            <SharedHalf>
              ...
              <template #right>
                <div
                  class="mt-[40px] flex gap-[20px] lg:mt-[0px] lg:flex-col lg:gap-[0px] lg:text-right"
                >
                  <!-- TODO: UPDATE LINKS -->
                  <a
